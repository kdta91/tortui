...
with one named exception: `github.com/anacrolix/torrent`, the torrent engine this project
depends on, is MPL-2.0, a file-level copyleft license whose obligations attach to that
dependency's own source files and do not extend to tortui's MIT-licensed code. See
